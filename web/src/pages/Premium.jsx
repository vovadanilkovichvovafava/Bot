...
const PAYMENT_METHODS = [
  {
    id: 'usdt',
    name: 'USDT (TRC20)',
    subtitle: 'Tether on Tron network',
    icon: '\u20AE',
  },
  {
    id: 'ton',
    name: 'TON',
    subtitle: 'Telegram Open Network',
    icon: '\u25C6',
  },
];
      ...
      <div className="flex-1 min-h-0 overflow-y-auto">
        ...
        <div className="px-5 pt-4 pb-8 space-y-6">
          ...
          <div className="bg-amber-50 rounded-2xl p-6 text-center">
            <img src={logoSvg} alt="PVA" className="w-16 h-16 mx-auto mb-3" />
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Premium Access</h2>
            <p className="text-gray-600">Unlimited AI predictions with 70%+ accuracy</p>
          </div>
