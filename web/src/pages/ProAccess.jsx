  ...
  return (
    <div className="min-h-screen bg-[#F0F4F8] overflow-y-auto pb-28" style={{ fontFamily: "'Plus Jakarta Sans', -apple-system, sans-serif" }}>
      ...
      >
        ...
        {/* PRO icon with logo */}
        <div
          className="w-16 h-16 rounded-[20px] flex items-center justify-center mx-auto mb-4 relative z-10 animate-[fadeUp_0.4s_ease_both] overflow-hidden"
          style={{ background: 'linear-gradient(135deg, #F7C948 0%, #E8A317 50%, #D4940F 100%)', boxShadow: '0 4px 20px rgba(232,163,23,0.3)' }}
        >
          <img src={logoPng} alt="PVA" className="w-14 h-14 rounded-2xl object-cover" />
        </div>
