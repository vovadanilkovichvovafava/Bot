...
const ADVERTISERS_CONFIG = {
  ...
  PT: {
    ...
    bonusBanner: { deposit: '€50', bonus: '€100', total: '€150' },
    texts: {
      freeBet: 'Aposta grátis de 100 euros',
      betOnMatch: 'Aposta em qualquer jogo',
      ctaButton: 'Aposta grátis de 100 euros',
      promoTitle: 'Aposta grátis de 100 euros',
      promoCta: 'Fazer aposta',
      promoCtaFree: 'Fazer aposta grátis',
      bonusButton: 'Aposta grátis de 100 euros',
      bestBets: 'Melhores apostas',
      useFreeBet: 'Usa a tua aposta grátis e ganha',
      potentialWin: 'Ganho',
      freeBetLabel: 'Aposta grátis',
      betAndTakeIt: 'Usa-a agora!',
    },
  },
...
export const ADVERTISERS = {
  ...
  PT: ADVERTISERS_CONFIG.PT,   // Portugal → Portuguese
  BR: ADVERTISERS_CONFIG.PT,   // Brazil → Portuguese
  MX: ADVERTISERS_CONFIG.ES,   // Mexico → Spanish
  AR: ADVERTISERS_CONFIG.ES,   // Argentina → Spanish
