...
const ADVERTISERS_CONFIG = {
  ...
  IT: {
    ...
    texts: {
      ...
      ctaButton: 'Scommessa gratuita da 75 euro',
      promoTitle: 'Scommessa gratuita da 75 euro',
      promoCta: 'Piazza la scommessa',
      promoCtaFree: 'Piazza scommessa gratuita',
      bonusButton: 'Scommessa gratuita da 75 euro',
  ...
  ES: {
    ...
    bonusBanner: { deposit: '€50', bonus: '€75', total: '€125' },
    texts: {
      freeBet: 'Apuesta gratuita de 75 euros',
      betOnMatch: 'Apuesta en cualquier partido',
      ctaButton: 'Apuesta gratuita de 75 euros',
      promoTitle: 'Apuesta gratuita de 75 euros',
      promoCta: 'Realizar apuesta',
      promoCtaFree: 'Realizar apuesta gratuita',
      bonusButton: 'Apuesta gratuita de 75 euros',
  ...
  FR: {
    ...
    bonusBanner: { deposit: '€50', bonus: '€75', total: '€125' },
    texts: {
      freeBet: 'Pari gratuit de 75 euros',
      betOnMatch: 'Pariez sur n\'importe quel match',
      ctaButton: 'Pari gratuit de 75 euros',
      promoTitle: 'Pari gratuit de 75 euros',
      promoCta: 'Placer le pari',
      promoCtaFree: 'Placer un pari gratuit',
      bonusButton: 'Pari gratuit de 75 euros',
  ...
  DE: {
    ...
    texts: {
      ...
      ctaButton: 'Kostenlose Wette 75 Euro',
      promoTitle: 'Kostenlose Wette 75 Euro',
      promoCta: 'Wette platzieren',
      promoCtaFree: 'Gratiswette platzieren',
      bonusButton: 'Kostenlose Wette 75 Euro',
  ...
  EUR: {
    ...
    bonusBanner: { deposit: '€50', bonus: '€75', total: '€125' },
    texts: {
      freeBet: 'Free bet of €75',
      betOnMatch: 'Bet on any match',
      ctaButton: 'Free bet of €75',
      promoTitle: 'Free bet of €75',
      promoCta: 'Place bet',
      promoCtaFree: 'Place free bet',
      bonusButton: 'Free bet of €75',
      bestBets: 'Best bets',
