          ...
          <>
            ...
            {recommendedBet ? (
                ...
                >
                  ...
                  <div className="relative p-4">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: '#F7C948' }}>{t('liveMatch.aiLiveBetRecommendation')}</span>
                    </div>
                    ...
                    <div className="rounded-xl p-3 border border-white/10" style={{ background: 'rgba(255,255,255,0.06)' }}>
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-lg font-black" style={{ color: '#F7C948' }}>&euro;{potentialWin}</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div
                ...
                style={{ background: 'linear-gradient(160deg, #0F2744 0%, #1B3A5C 40%, #2B5A8C 100%)' }}
                onClick={() => { trackClick(user?.id, 'live_free_bet_banner'); window.open(getTrackingLink(user?.id, 'live_free_bet_banner') || advertiser?.link, '_blank', 'noopener,noreferrer'); }}
              >
