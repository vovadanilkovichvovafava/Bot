            ...
            <div className="relative">
              ...
              <div className="mt-3 flex items-center justify-between bg-white/10 rounded-xl px-4 py-2.5">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-bold">{t('home.freeBetOnExpress', { bonus: advertiser?.bonusBanner?.bonus || '€100', defaultValue: `${advertiser?.bonusBanner?.bonus || '€100'} free bet on your express` })}</span>
                </div>
