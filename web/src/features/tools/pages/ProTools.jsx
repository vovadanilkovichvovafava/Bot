    ...
    <div className="pb-20">
      ...
      <div className="px-5 pt-2 pb-4 space-y-4">
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-white/70 text-sm">
                ...
                {(isPremium || isFunnel2) ? t('express.proCustomAvailable', { defaultValue: 'Custom express available' }) : t('express.dailyFreeCustomPro', { defaultValue: 'Daily free · Custom with PRO' })}
              </div>
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-white/70 text-sm">
                ...
                {(isPremium || isFunnel2) ? t('proTools.unlimitedScans') : valueBetUsed ? t('proTools.depositToUnlock') : t('proTools.tryFreeNow')}
              </div>
              <div className="bg-white text-blue-600 font-semibold px-4 py-2 rounded-lg text-sm flex items-center gap-1">
                {isPremium || isFunnel2 || !valueBetUsed ? t('proTools.findValueBets') : t('proTools.unlock')}
                <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3"/>
                </svg>
              </div>
        ...
        <ToolCard
          ...
          pro={!isPremium && !isFunnel2}
          locked={!isPremium && !isFunnel2}
